 ...
 * @requires jQuery
 *
 * Examples at http://lab.veno.it/lightbox/
 * License: MIT License
 * License URI: https://github.com/nicolafranchini/lightbox/blob/master/LICENSE
...
! function(t) {
    function a() {
        t.ajax({
            ...
            u.html('<div class="vbox-inline"><p>No Image</div>'), l(!0)
        })
    }
    ...
    t.fn.extend({
        lightbox: function(l) {
            ...
            return this.each(function() {
                var l = t(this);
                return l.data("lightbox") ? !0 : (l.addClass("vbox-item"), l.data("framewidth", D.framewidth), l.data("frameheight", D.frameheight), l.data("border", D.border), l.data("bgcolor", D.bgcolor), l.data("numeratio", D.numeratio), l.data("infinigall", D.infinigall), l.data("overlayclose", D.overlayclose), l.data("lightbox", !0), void l.click(function(d) {
                    function Q() {
